...
This means one can have an always-on Altaird instance running, and another local Altaird/Altair-qt instance which connects to this node and receives blocks from it.

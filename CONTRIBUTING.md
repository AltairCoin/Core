Contributing to Altair Core
============================

The Altair Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Altair Core project, and is not to be
confused with overall Altair Network Protocol consensus changes.

Whether a pull request is merged into Altair Core rests with the project merge
...
Patches that change Altair consensus rules are considerably more involved than
...
Where a patch set proposes to change the Altair consensus, it must have been
...
The project leader is the release manager for each Altair Core release.

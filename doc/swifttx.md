...
This mechanism has been integrated into Bitcore-Node-Altair which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Altair-Project/insight-api-Altair#web-socket-api](https://github.com/Altair-Project/insight-api-Altair#web-socket-api) 
* API: [https://github.com/Altair-Project/insight-api-Altair#swifttx-transactions](https://github.com/Altair-Project/insight-api-Altair#swifttx-transactions) 
...
By default, the Altair Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Altair Core daemon:

...
In order to support loading of multiple wallets in Altair-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Altair.cpp.
...
Changes to Altair.cpp
----------------------
Altair.cpp is the entry point into Altair-qt, and as such, will require some minor modifications to provide hooks for

...
void FillBlockPayee(CMutableTransaction& txNew, CAmount nFees, bool fProofOfStake)
{
    ...
    if ((IsSporkActive(SPORK_13_ENABLE_SUPERBLOCKS) && budget.IsBudgetPaymentBlock(pindexPrev->nHeight + 1)) || chainActive.Height() < Params().LAST_POW_BLOCK()) {
...
{
    if ((IsSporkActive(SPORK_13_ENABLE_SUPERBLOCKS) && budget.IsBudgetPaymentBlock(nBlockHeight)) || chainActive.Height() < Params().LAST_POW_BLOCK()) {

...
/** Utility functions used by the Altair Qt UI.
 */
namespace GUIUtil
{
...
// Render Altair addresses in monospace font
...
// Parse "Altair:" URI into recipient object, return true on successful parsing

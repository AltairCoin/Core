...
/* Altair GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Altair"
#define QAPP_ORG_DOMAIN "Altair.org"
#define QAPP_APP_NAME_DEFAULT "Altair-Qt"
#define QAPP_APP_NAME_TESTNET "Altair-Qt-testnet"

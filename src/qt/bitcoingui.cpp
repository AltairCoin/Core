                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Altair Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Altair address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Altair: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Altair Core"), this);
    aboutAction->setStatusTip(tr("Show information about Altair Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Altair"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Altair addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Altair addresses"));
    ...
    openAction->setStatusTip(tr("Open a Altair: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Altair Core help message to get a list with possible Altair command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Altair Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Altair network", "", count));
}
...
{
    QString strTitle = tr("Altair Core"); // default title

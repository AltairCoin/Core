...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Altair features */
        {"Altair", "masternode", &masternode, true, true, false},
        {"Altair", "listmasternodes", &listmasternodes, true, true, false},
        {"Altair", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Altair", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Altair", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Altair", "masternodedebug", &masternodedebug, true, true, false},
        {"Altair", "startmasternode", &startmasternode, true, true, false},
        {"Altair", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Altair", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Altair", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Altair", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Altair", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Altair", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Altair", "mnbudget", &mnbudget, true, true, false},
        {"Altair", "preparebudget", &preparebudget, true, true, false},
        {"Altair", "submitbudget", &submitbudget, true, true, false},
        {"Altair", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Altair", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Altair", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Altair", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Altair", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Altair", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Altair", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Altair", "checkbudgets", &checkbudgets, true, true, false},
        {"Altair", "mnsync", &mnsync, true, true, false},
        {"Altair", "spork", &spork, true, true, false},
        {"Altair", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"Altair", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> Altair-cli " + methodname + " " + args + "\n";
}
